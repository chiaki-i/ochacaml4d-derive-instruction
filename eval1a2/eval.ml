...
(* gather run functions for metacontinuations, to be refunctionalized
 * in eval1a2b *)
...
let rec f e xs vs c t m =
  ...
  | Shift0 (x, e) -> run_m (F (f e (x :: xs) (VContS (c, t) :: vs))) m
  | Control0 (x, e) -> run_m (F (f e (x :: xs) (VContC (c, t) :: vs))) m
