...
(* inline run_i9 into run_c9 completely : eval10sv *)
...
(*| (IReturn' :: c, s, VK (c', r') :: r) ->
  ...
  | (IShift (i) :: c, s, VS (vs) :: r) ->
    run_c9 (i :: idc) [] (VS (VContS (c, s, r, t) :: vs) :: []) TNil m
  | (IControl (i) :: c, s, VS (vs) :: r) ->
    run_c9 (i :: idc) [] (VS (VContC (c, s, r, t) :: vs) :: []) TNil m
  | (IShift0 (i) :: c, s, VS (vs) :: r) ->
    begin match m with
        MCons ((c0, s0, r0, t0), m0) ->
        run_c9 (i :: c0) s0 (VS (VContS (c, s, r, t) :: vs) :: r0) t0 m0
      | _ -> failwith "shift0 is used without enclosing reset"
    end
  | (IControl0 (i) :: c, s, VS (vs) :: r) ->
    begin match m with
        MCons ((c0, s0, r0, t0), m0) ->
        run_c9 (i :: c0) s0 (VS (VContC (c, s, r, t) :: vs) :: r0) t0 m0
      | _ -> failwith "control0 is used without enclosing reset"
    end
  | (IReset (i) :: c, s, VS (vs) :: r) ->
    run_c9 (i :: idc) [] (VS (vs) :: []) TNil (MCons ((c, s, r, t), m))
  | (ISeq (i0, i1) :: c, s, rv :: r) ->
    run_c9 (i0 :: i1 :: c) s (rv :: rv :: r) t m
