...
and f e xs vs c s t m = match e with
  ...
  | Op (e0, op, e1) ->
    f e1 xs vs (CSeq (COp1 (e0, xs, op), vs, c)) s t m
  | Fun (x, e) ->
  ...
  | App (e0, e1, _) ->
    f e1 xs vs (CSeq (CApp1 (e0, xs), vs, c)) s t m
  | Shift (x, e) ->
